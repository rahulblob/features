...
function rotaSettings(colour,hideIn){document.querySelector(".rota").style.borderColor = colour;document.querySelector(".rota").style.borderLeft = "3px solid rgba(255,255,255,.0)";setTimeout(()=>{document.querySelector(".rota").style.opacity = "0";document.querySelector(".rota").style.visibility = "hidden";},hideIn)};
